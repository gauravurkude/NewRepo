...
public  static class ProductsRepository
{
    public static  List<Product> GetAll()
    {
            ...
            List<Product> allProducts = new List<Product>();
            string restoredJsonString = File.ReadAllText(@"D:\C#_NET\S&G\OnlineShopping\Test\products.json");
    ...
    public static bool Insert(Product prod)
    {
        ...
        File.WriteAllText(@"D:\C#_NET\S&G\OnlineShopping\Test\products.json", jsonString);
